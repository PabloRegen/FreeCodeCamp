...
Here are some helpful links:  Array.splice()  String.replace()  Array.join()  */


// Solution #1
function myReplace(str, before, after) {
    return (before[0] === before[0].toUpperCase()) ? str.replace(before, after[0].toUpperCase() + after.slice(1)) : str.replace(before, after[0].toLowerCase() + after.slice(1));
}
...
console.log(myReplace("Let us get back to more Coding", "Coding", "bonfires")) //  should return "Let us get back to more Bonfires".